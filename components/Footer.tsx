                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <div className="flex space-x-4 mb-6">
                            <SocialIcon href="https://github.com/blockx3/" icon={Github} hoverColor="hover:text-gray-900 dark:hover:text-white" />
                            <SocialIcon href="https://www.linkedin.com/" icon={Linkedin} hoverColor="hover:text-blue-600" />
                            <SocialIcon href="https://instagram.com" icon={Instagram} hoverColor="hover:text-pink-600" />
                            <SocialIcon href="https://x.com/block_x3" icon={Twitter} hoverColor="hover:text-blue-400" />
                        </div>
